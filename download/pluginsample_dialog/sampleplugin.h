...
extern "C" PLUGIN_API int sampleplugin_getPluginAPIVersion();
extern "C" PLUGIN_API ScPlugin* sampleplugin_getPlugin();
extern "C" PLUGIN_API void sampleplugin_freePlugin(ScPlugin* plugin);
#endif
